module ApplicationHelper
	def buildings 
    	buildings = ["SSC", "Library", "Usdan", "Usen", "Renfield", "Deroy", "Shapiro", "Rosie North", "Rosie East", "Rosie South", "SCC", "Sherman", "Ridgewood A", "Ridgewood B", "Ridgewood C", "Reitman", "Cable", "Gordon", "Scheffres", "Hass", "Pom", "ICC", "Rabb Building", "Olin-Sang", "Golding", "Lown", "Shiffman", "Mandel", "Heller", "ASAC", "Castle", "Brown", "Schwartz", "Ziv 127", "Ziv 128", "Ziv 129", "Ziv 130", "Admissions", "Slosberg", "Gosman", "Medical Center", "Public Safety", "Pearlman Hall", "Mods", "Faculty Club", "Rose Art Museum", "Pollack", "Fine Arts Studio", "IBS", "Theater", "Village A", "Village B", "Village C", "Vertica", "Volen", "Goldsmith", "Bassine", "Gzang", "Abelson-Bass", "Rosenstiel", ""]      
  	end
